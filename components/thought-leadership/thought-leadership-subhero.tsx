...
interface ThoughtLeadershipSubHeroProps {
  /** A pre-rendered icon element — never a bare component reference, which can't cross the Server-to-Client boundary as a prop. */
...
export function ThoughtLeadershipSubHero({
  eyebrowIcon,
  eyebrowLabel,
  title,
  description,
  breadcrumbLabel,
}: ThoughtLeadershipSubHeroProps) {
  return (
